...
if page == "Input Data":
    ...
    try:
        ...
        if 'age' in regression_data.columns and 'sex' in regression_data.columns:
            scatter_fig = px.scatter(
                ...
                labels={'age': 'Usia (Tahun)', 'sex': 'Biaya Kesehatan yang Diprediksi'},
                color_continuous_scale=px.colors.sequential.Viridis
            )
            st.plotly_chart(scatter_fig)
        else:
            st.error("Kolom 'age' atau 'sex' tidak ditemukan dalam dataframe.")
